    ...
    return (
      <div className={`bg-slate-800/30 rounded-xl border border-slate-600/30 p-3 flex flex-col h-full ${className}`}>
        ...
        <div className="flex-1 min-h-0 flex items-center justify-center">
          <div className="text-slate-400 text-xs">Chargement...</div>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className={`bg-slate-800/30 rounded-xl border border-slate-600/30 p-3 flex flex-col h-full ${className}`}>
        ...
        <div className="flex-1 min-h-0 flex items-center justify-center">
          <div className="text-red-400 text-xs">Erreur de chargement</div>
        </div>
      </div>
    );
  }
  ...
  if (weeklySessions.length === 0) {
    return (
      <div className={`bg-slate-800/30 rounded-xl border border-slate-600/30 p-3 flex flex-col h-full ${className}`}>
        ...
        {/* Contenu vide - Prend l'espace disponible */}
        <div className="flex-1 min-h-0 flex items-center justify-center">
          <div className="text-center">
            <Calendar className="w-8 h-8 text-slate-500 mx-auto mb-2" />
            <p className="text-slate-400 text-xs">Aucune session planifiée</p>
