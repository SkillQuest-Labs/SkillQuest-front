...
export const SidebarHeader = () => {
  ...
  return (
    <div className={`flex ${isCollapsed ? "flex-col items-center gap-4" : "items-center justify-between"} p-6`}>
      <Link to="/" className={`${isCollapsed ? "flex flex-col items-center" : "flex items-center gap-2"} w-full`}>
      ...
      <Button
        ...
        className={`cursor-pointer ${isCollapsed ? "" : "ml-auto"} hover:bg-gray-700 p-2 rounded`}
      >
