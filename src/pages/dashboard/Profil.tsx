    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-5xl px-4">
        <div className="flex flex-col items-center justify-center">
          ...
          <SignedIn>
            <div className="relative rounded-2xl border border-none p-6 shadow-2xl backdrop-blur-md flex items-center justify-center">
              {/* Glow subtil */}
              <div className="pointer-events-none absolute -inset-1 rounded-2xl  blur-lg" />
