            ...
            <UserProfile
                  appearance={{
                    ...
                    elements: {
                      ...
                      navbarButton: "rounded-lg text-slate-200 hover:bg-slate-700/60 hover:text-white data-[active=true]:bg-blue-500/20 data-[active=true]:text-blue-300 transition-all duration-200 py-2 px-3",
                      ...
                      formFieldInput: "bg-slate-700/60 border border-slate-500/50 text-white placeholder-slate-300 rounded-lg focus:border-blue-400 focus:ring-blue-400/30 transition-all duration-200 py-3",
                      formFieldInputShowPasswordButton: "text-slate-300 hover:text-white",
                      
                      // Boutons
                      formButtonPrimary: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white font-semibold rounded-lg shadow-lg transition-all duration-200 py-3 px-6",
                      formButtonSecondary: "bg-slate-600 hover:bg-slate-500 text-white border border-slate-500 rounded-lg transition-all duration-200 py-3 px-6",
                      profileSectionPrimaryButton: "bg-blue-500 hover:bg-blue-400 text-white rounded-lg transition-all duration-200 py-3 px-6",
                      ...
                      // Badges et tags
                      badge: "bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 rounded-full px-2 py-1 text-xs font-medium",
            ...
            <SignIn
              appearance={{
                ...
                elements: {
                  ...
                  formButtonPrimary: "bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white rounded-lg",
                  formFieldInput: "bg-slate-800/70 border border-slate-600/50 text-white placeholder-slate-400 rounded-lg focus:border-amber-400 focus:ring-amber-400/30",
                },
              }}
            />
          </div>
