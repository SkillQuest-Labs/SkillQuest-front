...
export const SkillCard: React.FC<SkillCardProps> = ({ skill }) => (
  <div className="skill-card-custom group transition-all duration-200 hover:shadow-lg hover:-translate-y-1 flex flex-col min-h-[220px] p-5">
    <div className="flex items-start justify-between mb-2">
      <h3 className="font-semibold text-lg truncate max-w-[70%]" title={skill.title}>{skill.title}</h3>
    ...
    <div className="text-sm text-gray-600 mb-3 line-clamp-3" title={skill.description}>{skill.description}</div>
